...
<html>
  ...
  <body>
    <form class="layui-form" method="post" action="<%=request.getContextPath() %>/addProfess">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="depid" required  lay-verify="required" placeholder="请输入系别号" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
